# glory-of-empires-2023

A [re-frame](https://github.com/day8/re-frame) space board game.
...
* [`src/glory_of_empires_2023/styles.cljs`](src/glory_of_empires_2023/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/glory_of_empires_2023/`](src/glory_of_empires_2023/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/glory_of_empires_2023/core.cljs): contains the SPA entry point, `init`
* [`test/glory_of_empires_2023/`](test/glory_of_empires_2023/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
5. Clone this repo and open a terminal in the `glory-of-empires-2023` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/glory_of_empires_2023/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns glory-of-empires-2023.example
  (:require [glory-of-empires-2023.config :as config])
