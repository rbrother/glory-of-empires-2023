(ns glory-of-empires-2023.logic.races
...
(def all-races-arr
  [{:id :letnev :name "The Barony of Letnev" :unit-color "Grey"
    ...
    :abilities ["+1 to Fleet Supply"
                "May spend 2 Trade Goods to get +1 in actual round
                of space combat or +2 in ground combat"]
    :racial-techs [{:id :l4-disruptors, :cost 6}
